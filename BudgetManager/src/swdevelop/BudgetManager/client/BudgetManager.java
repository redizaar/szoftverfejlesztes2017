...
public class BudgetManager implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		registerButton.setStyleName("buttons");
		...
		registerLabel.setText("Doesn't have an account ?");		
		
		verticalPanel.add(registerLabel);
		verticalPanel.add(registerButton);
									...
									try {
										greetingService.registerUser(usernameTextBox.getText(),
											...
											public void onSuccess(Boolean result) {
												if(result)
												{
													Window.alert("Sikeresen regisztrálva!");
												}
												else
												{
